  ...
  return (
    <div className="pt-12 lg:pt-20 pb-5 px-4 md:px-8 lg:px-16 flex flex-col lg:flex-row gap-5 w-full bg-black items-stretch">
     <div className="bg-white rounded-lg p-7 flex flex-col gap-5 w-full lg:w-1/3 relative pb-20">
        <h5 className="text-3xl md:text-4xl lg:text-5xl font-normal tracking-tighter"><span className="text-yellow-400">Uncompromising</span> Quality</h5>
     ...
     <div className="bg-white rounded-lg p-7 flex flex-col gap-5 w-full lg:w-1/3 relative pb-20">
        <h5 className="text-3xl md:text-4xl lg:text-5xl font-normal tracking-tighter"><span className="text-yellow-400"> Strategic</span> Partnership</h5>
